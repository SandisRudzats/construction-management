  ...
  actions: {
    ...
    async fetchConstructionSites(user: User) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while fetching construction sites')
      } finally {
        this.loading = false
      }
    },
    ...
    async updateSite(id: number, updatedSite: ConstructionSite) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while updating construction site')
      } finally {
        this.loading = false
      }
    },
    ...
    async deleteSite(id: number) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while deleting construction site')
      } finally {
        this.loading = false
      }
    },
    ...
    async addTask(newTask: WorkTask) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while adding task for Construction site')
      } finally {
        this.loading = false
      }
    },
    ...
    async deleteTask(taskId: number) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while deleting Task')
      } finally {
        this.loading = false
      }
    },
    ...
    async fetchUserAssignedSites(user: User) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while fetching Employee assigned sites')
      } finally {
        this.loading = false
      }
    },
    ...
    async createConstructionSite(constructionSiteData: Omit<ConstructionSite, 'id' | 'workTasks'>) {
      ...
      try {
        ...
        this.handleError(err, 'An unknown error occurred while creating Construction site')
      } finally {
        this.loading = false
      }
    },
